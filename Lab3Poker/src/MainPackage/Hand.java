...
public class Hand {
	...
	public void EvalHand() {
		...
		if (Straight == true
				...
				&& Ace) {
			ScoreHand(eHandStrength.RoyalFlush,CardsInHand.get(eCardNo.FirstCard.getCardNo()).getRank()
					.getRank(), 0, remainingCards);
		}
		
		// Evaluate Natural Royal Flush
				if (Straight == true
						&& Flush == true
						&& CardsInHand.get(eCardNo.FifthCard.getCardNo()).getRank() == eRank.TEN
						&& Ace 
					...
					ScoreHand(eHandStrength.RoyalFlush,
		...
		// five of a Kind
				...
				eRank.JOKER){
		if(CardsInHand
				.get(eCardNo.SecondCard.getCardNo()).getRank() == CardsInHand.get(eCardNo.FifthCard.getCardNo()).getRank()){
			remainingCards = null;
